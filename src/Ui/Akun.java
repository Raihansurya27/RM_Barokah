...
public class Akun extends javax.swing.JFrame {
    ...
    public JComboBox<String> getCboJenisAkun() {
        return cboJenisAkun;
    }

    public void setCboJenisAkun(JComboBox<String> cboJenisAkun) {
        this.cboJenisAkun = cboJenisAkun;
    }
    ...
    private void initComponents() {
        ...
        akunTbl = new javax.swing.JTable();
        ...
        cboJenisAkun = new javax.swing.JComboBox<>();
        ...
        tanggalSekarang.setText("Sat, 2022-06-05");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(tanggalSekarang, javax.swing.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE))
                .addGap(18, 18, 18))
        );
        ...
        getContentPane().add(refreshBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 100, 140, 40));

        akunTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "No.", "Kode", "Nama Akun", "Password", "Peran"
            }
        ) {
        ...
        getContentPane().add(tambahBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 150, 140, 40));
        ...
        getContentPane().add(ubahBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 200, 140, 40));
        ...
        getContentPane().add(hapusBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 250, 140, 40));
        ...
        getContentPane().add(cariTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 110, 140, 30));

        cboJenisAkun.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cboJenisAkun.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboJenisAkunActionPerformed(evt);
            }
        });
        getContentPane().add(cboJenisAkun, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 110, 170, 30));
    ...
    private void ubahBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubahBtnActionPerformed
        // TODO add your handling code here:
        try{
                int row = this.getAkunTbl().getSelectedRow();
                String kode = this.getAkunTbl().getValueAt(row, 1).toString();
                new AkunForm(kode).show();
            }catch(Exception e){
                JOptionPane.showMessageDialog(this, "Pilih dahulu akun yang mau diubah");
            }
    ...
    private void hapusBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusBtnActionPerformed
        ...
        try{
                int row = this.getAkunTbl().getSelectedRow();
                String kode = this.getAkunTbl().getValueAt(row, 1).toString();
                int p = JOptionPane.showConfirmDialog(null, "Apakah yakin menghapus akun ini?", "Hapus Akun", JOptionPane.YES_NO_OPTION);
                if (p==0){
                    controller.delete(kode);
                    controller.viewAllTabel();
                }else{
                    JOptionPane.showMessageDialog(rootPane, "Proses penghapusan akun gagal", "Hapus Akun", HEIGHT);
                }
            }catch(Exception e){
                JOptionPane.showMessageDialog(this, "Pilih dahulu akun yang mau dihapus");
            }
    ...
    private void akunBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_akunBtnActionPerformed
        // TODO add your handling code here:
        this.show();
        JOptionPane.showMessageDialog(rootPane, "Kamu sudah berada di Halaman Akun");
    ...
    private void cariBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariBtnActionPerformed
        // TODO add your handling code here:
        kondisiAwal();
        String temp = getCboJenisAkun().getSelectedItem().toString();
    ...
    private void cboJenisAkunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboJenisAkunActionPerformed
        // TODO add your handling code here:
        if(controller!=null){
            kondisiAwal();
            cariTxt.setText("");
    ...
    }//GEN-LAST:event_cboJenisAkunActionPerformed
    ...
    private javax.swing.JTable akunTbl;
    private javax.swing.JButton cariBtn;
    private javax.swing.JTextField cariTxt;
    private javax.swing.JComboBox<String> cboJenisAkun;
